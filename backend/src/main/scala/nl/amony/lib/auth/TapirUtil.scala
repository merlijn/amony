...
val securityInput: EndpointInput[SecurityInput] = cookie[Option[String]]("access_token").and(extractFromRequest(_.header("X-XSRF-TOKEN")))
  .and(cookie[Option[String]]("XSRF-TOKEN")).mapTo[SecurityInput]
